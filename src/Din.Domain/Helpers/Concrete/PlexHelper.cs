...
namespace Din.Domain.Helpers.Concrete
{
    public class PlexHelper : IPlexHelper
    {
        ...
        public PlexHelper(IContentPollStatusRepository repository, IPlexClient client, IPlexConfig config)
        {
        ...
        public Task CheckIsOnPlex<T>(IEnumerable<T> content, CancellationToken cancellationToken) where T : IContent
        {
